...
class GTSEngineClient(object):
    ...
    def start_train(self, task_id=None, train_data=None, val_data=None, test_data=None, label_data=None, unlabel_data=None, max_num_epoch=1, min_num_epoch=1, seed=42, gpuid=0, train_mode="standard"):
